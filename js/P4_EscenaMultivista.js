...
function updateAspectRatio()
{
    ...
    *******************/
    ...
    if(ar>1){
        camaraOrto.left = -L*ar;
        camaraOrto.right = planta.right =perfil.right = L*ar;
        camaraOrto.top = planta.top= perfil.top=  L;
        camaraOrto.bottom = planta.bottom = perfil.bottom = -L;    
    }
    else{
        camaraOrto.left = -L;
        camaraOrto.right = L;
        camaraOrto.top = L/ar;
        camaraOrto.bottom = -L/ar;       
    }
